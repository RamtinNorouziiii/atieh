...
export default function JobOfferComp() {
    return (
        ...
        <Swiper
            ...
            preloadImages={false}
        >
            <SwiperSlide style={{ margin: "0px 10px",borderRadius:"10px" }}  >
                <Flex
                    minH={'100vh'}
                    align={'center'}
                    justify={'center'}
                    ...
                    <Stack
                        ...
                        <Stack align={'center'} spacing={2}>
                            ...
                            <Text fontSize={'lg'} color={'gray.500'}>
                                <Text> مسلط به مفاهیم دیجیتال مارکتینگ ●</Text>
                                <Text>  توانمند در هماهنگی و برنامه ریزی کمپین های تبلیغاتی ● </Text>
                                <Text>  مسلط به طراحی محتوای کمپین دیجیتال ، برنامه ریزی و بودجه بندی ●</Text>
                                <Text> آشنایی به مبانی طراحی و گرافیک : فوتوشاپ و افترافکت ●</Text>
                                <Text>توانایی تولید و انتشار محتوای تبلیغاتی ●</Text>
                                <Text> حداقل 3 سال سابقه کاری در گروه شغلی مشابه ●</Text>
                                ● حداقل کارشناسی یا کارشناسی ارشد در رشته‌های مرتبط آشنایی با مفاهیم سئو و بهینه‌سازی سایت
                                <Text>داشتن حداقل مهارت‌های فردی (انضباط فردی، روحیه تیمی، توسعه فردی و سازمانی، روابط عمومی،خلاقیت)●</Text>
                                <Text> توانایی متوسط در زبان انگلیسی («مطالعه و درك مطالب»، «مكالمه» و «نوشتن متون انگليسي») ●</Text>
                                <Text> ارسال رزومه به آدرس ایمیل : HR@behpardakht.com و درج عنوان شغلی در قسمت subject ●</Text>
                            </Text>
                        </Stack>
